                ...
                <div className="card-body">
                    <div className="row">
                        ...
                        <div className="col-9">
                            ...
                            <div className="row">
                                <span className="mt-2 fs-5 fw-bold">First Stage</span>
                                <div className="col-3 mt-1">
                            ...
                            <div className="row">
                                <span className="mt-2 fs-5 fw-bold">Second Stage</span>
                                <div className="col-3 mt-1">
                                ...
                                <div className="col-3 mt-1">
                                    <label htmlFor="composite_fairing_height" className="form-label">Composite Fairing -
                                        Height</label>
                                ...
                                <div className="col-3 mt-1">
                                    <label htmlFor="composite_fairing_diameter" className="form-label">Composite Fairing
                                        - Diameter</label>
                            ...
                            <div className="row">
                                ...
                                <div className="col-3 mt-1">
                                    <label htmlFor="fuel_amount_tons_second_stage" className="form-label">Fuel Amount
                                        (tons)</label>
                            ...
                            <div className="row">
                                <span className="mt-2 fs-5 fw-bold">Engines</span>
                                <div className="col-3 mt-1">
                            ...
                            <div className="row">
                                ...
                                <div className="col-3 mt-1">
                                    <label htmlFor="engines_propellant_1" className="form-label">Propellant 1</label>
                            ...
                            <div className="row">
                                <div className="col-3 mt-1">
                                    <label htmlFor="engines_propellant_2" className="form-label">Propellant 2</label>
                                    <input type="text" className="form-control" id="engines_propellant_2"
                                           disabled={disableFields}
                                           value={rocket.engines?.propellant_2}/>
                                </div>
                                <div className="col-3 mt-1">
                                    <label htmlFor="engines_thrust_to_weight" className="form-label">Thrust to Weight</label>
